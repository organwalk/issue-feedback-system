...
public interface IssueDAO {
    ...
    @Select("select issue.title,issue.`desc`,issue.type_id,ic.type_name,issue.status_id,i.status_name from issue left join issue_category ic on ic.type_id = issue.type_id left join issue_status i on i.status_id = issue.status_id where issue_id = #{issueId}")
